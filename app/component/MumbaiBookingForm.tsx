...
const MumbaiBookingForm = () => {
  ...
  useEffect(() => {
    const checkToken = async () => {
      ...
      console.log('MumbaiBookingForm: Stored lastVisitedPage as:', referrer);
  ...
  return (
    <>
      {loaderActive && <Loader />}
      {bookLoaderActive && <BookingLoader id="mumbai-booking" />}
      ...
      <section className="allBookingForm localForm margin-top-bottom">
        <div className="container">
          <div className="row justify-content-end pt-3 pb-3">
            <div className="bookForm test shadow-lg col-12 col-md-7 col-lg-5">
              ...
              <h1 className="p-3 h5 mb-2 formHead test">Local Mumbai</h1>
              <form
        ...
        {/* Local Rates Modal */}
        <LocalRatesModal location="mumbai" />
      </section>
      <Modal
        open={errorModalOpen}
      ...
      >
        ...
        >
          ...
          <Typography id="error-modal-description" component="div" sx={{ mt: 2 }}>
            {errorModalMessage}
            <p>
              Any Query -{" "}
              <Link
...
export default MumbaiBookingForm;
